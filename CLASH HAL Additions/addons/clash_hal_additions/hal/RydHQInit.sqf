...
// CLASH HAL Additions: HAL's VarInit, then CLASH's copies of the HAL scripts it
// fixes, in one unscheduled step so no script ever captures HAL's originals.
isNil {
...
call compile preprocessFileLineNumbers "\clash_hal_additions\hal\TaskInitNR6.sqf";
